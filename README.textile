...
phylogeographic models ("BEAST software":http://beast.bio.ed.ac.uk/Main_Page). 
Contains visualisations (templates), wrapped in a user friendly interface. 
Supported visualisations include embedded Processing applets and KML output for viewing 
in Google Earth or any other virtual globe software capable of reading the format.
...
* Add an editor for locations file/  
* Add drop-down panels/
