...
* Eliminate text fields, fill combo boxes with parsed trait names instead -> start with BF indicator attribute name
* Input sanity check for BF indicator attribute name
* Less dependencies:
