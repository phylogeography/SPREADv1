...
S.P.R.E.A.D. is a Java program supporting processing and visualizations of BEAST's phylogeographic models ("BEAST software":http://beast.bio.ed.ac.uk/Main_Page). 
...
* TimeSlicer template
  - give the concurrent implementation of AnalyzeTree another try. This might be achieveable with ConcurrentHashMap class  
  - Polygons should also be easily executed in parallel (read only operation), the problem is in getting the style id's right  
